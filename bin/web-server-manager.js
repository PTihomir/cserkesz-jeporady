var util = require('util'),
    ...
    managerServer = require('./manager.js');

var DEFAULT_PORT = 3001;

var defaultPage = 'app/manager-screen.html';
...
function main(argv) {
    ...
    var manager = managerServer(httpserver.getServer(), Number(argv[3]));
